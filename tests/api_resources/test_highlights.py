...
class TestHighlights:
    ...
    def test_method_list(self, client: ReadwiseSDK) -> None:
        highlight = client.highlights.list()
    ...
    def test_raw_response_list(self, client: ReadwiseSDK) -> None:
        response = client.highlights.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: ReadwiseSDK) -> None:
        with client.highlights.with_streaming_response.list() as response:
...
class TestAsyncHighlights:
    ...
    async def test_method_list(self, async_client: AsyncReadwiseSDK) -> None:
        highlight = await async_client.highlights.list()
        assert_matches_type(HighlightListResponse, highlight, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncReadwiseSDK) -> None:
        response = await async_client.highlights.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncReadwiseSDK) -> None:
        async with async_client.highlights.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
