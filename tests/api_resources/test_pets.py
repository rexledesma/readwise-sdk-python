...
from readwise_sdk.types import (
    Pet,
    APIResponse,
...
class TestPets:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_update(self, client: ReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_update_with_all_params(self, client: ReadwiseSDK) -> None:
        pet = client.pets.update(
            name="doggie",
            photo_urls=["string"],
            id=10,
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_update(self, client: ReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_update(self, client: ReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_find_by_status(self, client: ReadwiseSDK) -> None:
        pet = client.pets.find_by_status()
        assert_matches_type(PetFindByStatusResponse, pet, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_method_find_by_status_with_all_params(self, client: ReadwiseSDK) -> None:
        pet = client.pets.find_by_status(
            status="available",
        )
        assert_matches_type(PetFindByStatusResponse, pet, path=["response"])
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_find_by_status(self, client: ReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_find_by_status(self, client: ReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_find_by_tags(self, client: ReadwiseSDK) -> None:
        pet = client.pets.find_by_tags()
        assert_matches_type(PetFindByTagsResponse, pet, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_method_find_by_tags_with_all_params(self, client: ReadwiseSDK) -> None:
        pet = client.pets.find_by_tags(
            tags=["string"],
        )
        assert_matches_type(PetFindByTagsResponse, pet, path=["response"])
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_find_by_tags(self, client: ReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_find_by_tags(self, client: ReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_update_by_id(self, client: ReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_update_by_id_with_all_params(self, client: ReadwiseSDK) -> None:
        pet = client.pets.update_by_id(
            pet_id=0,
            name="name",
            status="status",
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_update_by_id(self, client: ReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_update_by_id(self, client: ReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_upload_image(self, client: ReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_upload_image_with_all_params(self, client: ReadwiseSDK) -> None:
        pet = client.pets.upload_image(
            pet_id=0,
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_upload_image(self, client: ReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_upload_image(self, client: ReadwiseSDK) -> None:
...
class TestAsyncPets:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_update(self, async_client: AsyncReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_update_with_all_params(self, async_client: AsyncReadwiseSDK) -> None:
        pet = await async_client.pets.update(
            name="doggie",
            photo_urls=["string"],
            id=10,
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_update(self, async_client: AsyncReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_update(self, async_client: AsyncReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_find_by_status(self, async_client: AsyncReadwiseSDK) -> None:
        pet = await async_client.pets.find_by_status()
        assert_matches_type(PetFindByStatusResponse, pet, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_method_find_by_status_with_all_params(self, async_client: AsyncReadwiseSDK) -> None:
        pet = await async_client.pets.find_by_status(
            status="available",
        )
        assert_matches_type(PetFindByStatusResponse, pet, path=["response"])
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_find_by_status(self, async_client: AsyncReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_find_by_status(self, async_client: AsyncReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_find_by_tags(self, async_client: AsyncReadwiseSDK) -> None:
        pet = await async_client.pets.find_by_tags()
        assert_matches_type(PetFindByTagsResponse, pet, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_method_find_by_tags_with_all_params(self, async_client: AsyncReadwiseSDK) -> None:
        pet = await async_client.pets.find_by_tags(
            tags=["string"],
        )
        assert_matches_type(PetFindByTagsResponse, pet, path=["response"])
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_find_by_tags(self, async_client: AsyncReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_find_by_tags(self, async_client: AsyncReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_update_by_id(self, async_client: AsyncReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_update_by_id_with_all_params(self, async_client: AsyncReadwiseSDK) -> None:
        pet = await async_client.pets.update_by_id(
            pet_id=0,
            name="name",
            status="status",
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_update_by_id(self, async_client: AsyncReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_update_by_id(self, async_client: AsyncReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_upload_image(self, async_client: AsyncReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_upload_image_with_all_params(self, async_client: AsyncReadwiseSDK) -> None:
        pet = await async_client.pets.upload_image(
            pet_id=0,
            additional_metadata="additionalMetadata",
            image=b"raw file contents",
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_upload_image(self, async_client: AsyncReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_upload_image(self, async_client: AsyncReadwiseSDK) -> None:
