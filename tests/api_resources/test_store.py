...
class TestStore:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_inventory(self, client: ReadwiseSDK) -> None:
        store = client.store.inventory()
        assert_matches_type(StoreInventoryResponse, store, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_inventory(self, client: ReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_inventory(self, client: ReadwiseSDK) -> None:
...
class TestAsyncStore:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_inventory(self, async_client: AsyncReadwiseSDK) -> None:
        store = await async_client.store.inventory()
        assert_matches_type(StoreInventoryResponse, store, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_inventory(self, async_client: AsyncReadwiseSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_inventory(self, async_client: AsyncReadwiseSDK) -> None:
