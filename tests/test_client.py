            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "readwise_sdk/_legacy_response.py",
                        "readwise_sdk/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "readwise_sdk/_compat.py",
...
class TestAsyncReadwise:
    ...
    def test_get_platform(self) -> None:
        ...
        from readwise_sdk._utils import asyncify
        from readwise_sdk._base_client import get_platform 
